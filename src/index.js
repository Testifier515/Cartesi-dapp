...
const getHCM = (firstNumber, secondNumber) => firstNumber * secondNumber
...
async function handle_advance(data) {
  ...
  const result = getHCM(firstNumber, secondNumber);
...
async function handle_inspect(data) {
  ...
  const responseObject = "Inspect route not implemented for hcm of numbers";
